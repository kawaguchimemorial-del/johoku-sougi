...
export const disclaimer =
  "城北セレモニーサポートセンターは、戸田斎場・舟渡斎場・北区セレモニーホール・蓮根レインボーホール・町屋斎場など各施設の公式サイトではありません。運営・施行は川口典礼です。";

// 掲載内容（料金目安・斎場情報・制度）の最終確認日。内容を見直したら更新する。
export const contentCheckedAt = "2026-09-24";
